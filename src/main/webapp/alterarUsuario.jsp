...
<title>Alteração do usuario ${usuario.NOME_U}</title>
...
<!--Início da navbar-->
  ...
  <!--Fim da navbar-->
	...
	<div class="container pt-5 pb-5">
		<h5 class="pt-5">Alteração do usuário: ${usuario.NOME_U}</h5>
		<form action="editar" method="post" class="form-control">

			<input type="hidden" name="id" value="${usuario.ID_USUARIO}">
			<p>Nome Completo:</p>
			<p>
				<input size="35" type="text" name="nome" value="${usuario.NOME_U}">
			</p>
			<p>E-mail:</p>
			<p>
				<input size="35" type="email" name="email" value="${usuario.EMAIL_U}">
			</p>
			<p>Senha:</p>
			<p>
				<input size="35" type="password" name="senha" value="${usuario.SENHA_U}">
			</p>
